...
contract ClosedSeaNFTController is ERC721Holder, Ownable, Pausable {
    ...
    function buyToken(address _tokenAddr, uint256 _tokenId) public payable whenNotPaused notBanned(_tokenAddr, _tokenId) {
    ...
    function setCurrentPrice(address _tokenAddr, uint256 _tokenId, uint256 _price) public whenNotPaused notBanned(_tokenAddr, _tokenId) {
        bytes32 key = _getKey(_tokenAddr, _tokenId);
    ...
    function readyToSellToken(address _tokenAddr, uint256 _tokenId, uint256 _price, string memory _category, bool _withEther) public whenNotPaused notBanned(_tokenAddr, _tokenId) {
    ...
    function cancelSellToken(address _tokenAddr, uint256 _tokenId) public whenNotPaused notBanned(_tokenAddr, _tokenId) {
        bytes32 key = _getKey(_tokenAddr, _tokenId);
    ...
    function getCategoryOf(address _tokenAddr, uint256 _tokenId) public view returns (string memory) {
        bytes32 key = _getKey(_tokenAddr, _tokenId);
    ...
    function bidToken(address _tokenAddr, uint256 _tokenId, uint256 _price, bool _withEther) public payable whenNotPaused notBanned(_tokenAddr, _tokenId) {
        require(_msgSender() != address(0) && _msgSender() != address(this), 'Wrong msg sender');
        require(_price != 0, 'Price must be granter than zero');
        bytes32 key = _getKey(_tokenAddr, _tokenId);
    ...
    function updateBidPrice(address _tokenAddr, uint256 _tokenId, uint256 _price) public payable whenNotPaused notBanned(_tokenAddr, _tokenId) {
        bytes32 key = _getKey(_tokenAddr, _tokenId);
    ...
    function cancelBidToken(address _tokenAddr, uint256 _tokenId) public whenNotPaused notBanned(_tokenAddr, _tokenId) {
        bytes32 key = _getKey(_tokenAddr, _tokenId);
